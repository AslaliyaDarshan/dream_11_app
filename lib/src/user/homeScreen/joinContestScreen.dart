      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: const [
            Text(
              'Pk Vs Ind',
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400,fontFamily: "Imprima"),
            ),
            SizedBox(
              height: 4,
            ),
        ...
        bottom: TabBar(
          ...
          tabs:  [
            Tab(
              child: Text(
                'Full Match',
                style: TextStyle(fontWeight: FontWeight.w400, fontSize: 15.sp,fontFamily: "Imprima"),
              ),
            ),
            Tab(
              child: Text(
                        ...
                        child:  Center(
                          child: Text(
                            ...
                            style: TextStyle(
                                color: Colors.white,
                                fontSize: 15.sp,
                                fontWeight: FontWeight.w500,fontFamily: "Imprima"),
                          ),
                        ),
                      ),
                    ],
                      ...
                      child: Row(
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                                fontSize: 14.sp,
                                color: Color.fromRGBO(131, 129, 129, 1),fontFamily: "Imprima"),
                          ),
                          SizedBox(
                            width: 2.w,
                          ),
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                              ...
                              color: selectedBottomBarIndex == 0
                                  ? const Color.fromRGBO(0, 100, 0, 1)
                                  : Colors.black,fontFamily: "Imprima"
                          ),
                        ),
                      ],
                    ),
