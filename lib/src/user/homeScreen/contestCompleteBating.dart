...
class ContestCompleteBating extends StatefulWidget {
  ...
  @override
  State<ContestCompleteBating> createState() => _ContestCompleteBatingState();
}

class _ContestCompleteBatingState extends State<ContestCompleteBating> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              InkWell(
                onTap: () {
                  cnt.batingIndex.value = 1;
                },
                child: Container(
                  height: 5.5.h,
                  width: 32.w,
                  alignment: Alignment.center,
                  color: cnt.batingIndex.value == 1
                      ? backgroundGreenClr
                      : Colors.white,
                  child: text("My Contests(0)", 16.5.sp,
                      cnt.batingIndex.value == 1 ? Colors.white : textGreyClr),
                ),
              ),
              InkWell(
                onTap: () {
                  cnt.batingIndex.value = 2;
                },
                child: Container(
                  height: 5.5.h,
                  width: 32.w,
                  alignment: Alignment.center,
                  color: cnt.batingIndex.value == 2
                      ? backgroundGreenClr
                      : Colors.white,
                  child: text("My Teams(0)", 16.5.sp,
                      cnt.batingIndex.value == 2 ? Colors.white : textGreyClr),
                ),
              ),
              InkWell(
                onTap: () {
                  cnt.batingIndex.value = 3;
                },
                child: Container(
                  height: 5.5.h,
                  width: 32.w,
                  alignment: Alignment.center,
                  color: cnt.batingIndex.value == 3
                      ? backgroundGreenClr
                      : Colors.white,
                  child: text("Player Status", 16.5.sp,
                      cnt.batingIndex.value == 3 ? Colors.white : textGreyClr),
                ),
              ),
            ],
          ),
