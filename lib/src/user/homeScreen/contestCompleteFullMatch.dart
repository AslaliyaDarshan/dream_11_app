...
class ContestCompleteFullMatch extends StatefulWidget {
  ...
  @override
  State<ContestCompleteFullMatch> createState() =>
      _ContestCompleteFullMatchState();
}

class _ContestCompleteFullMatchState extends State<ContestCompleteFullMatch> {
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: text("My Contests(0)", 16.5.sp,
                        cnt.index.value == 1 ? Colors.white : textGreyClr),
                  ),
                ),
                InkWell(
                  onTap: () {
                  ...
                  child: Container(
                    ...
                    child: text("My Teams(0)", 16.5.sp,
                        cnt.index.value == 2 ? Colors.white : textGreyClr),
                  ),
                ),
                InkWell(
                  onTap: () {
                  ...
                  child: Container(
                    ...
                    child: text("Player Status", 16.5.sp,
                        cnt.index.value == 3 ? Colors.white : textGreyClr),
                  ),
                ),
              ],
            ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: text(
                                        "Rs.51,00,000", 18.sp, Colors.black),
                                  ),
                                  const Divider(
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        text(
                                            "Guaranteed", 17.sp, Colors.black54)
                                      ],
                                    ),
                                  ),
                                  height(1.h),
